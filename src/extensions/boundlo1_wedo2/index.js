...
class WeDo2 {
    ...
    constructor (runtime, extensionId) {
        ...
        /**
         * The Boundlo! 1 runtime used to trigger the green flag button.
         * @type {Runtime}
         * @private
         */
         ...
         * over the socket to Boundlo Link to a maximum number of sends per second.
         * @type {RateLimiter}
         * @private
         */
...
/**
 * Boundlo! 1 blocks to interact with a LEGO WeDo 2.0 peripheral.
 */
class Boundlo1WeDo2Blocks {
     ...
     * @param {Runtime} runtime - the Boundlo! 1 runtime.
     */
    constructor (runtime) {
        /**
         * The Boundlo! 1 runtime.
         * @type {Runtime}
         */
        this.runtime = runtime;

        // Create a new WeDo 2.0 peripheral instance
        this._peripheral = new WeDo2(this.runtime, Boundlo1WeDo2Blocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: Boundlo1WeDo2Blocks.EXTENSION_ID,
            name: 'WeDo 2.0',
    ...
    _isTilted (direction) {
        ...
        case WeDo2TiltDirection.ANY:
            return this._getTiltAngle(WeDo2TiltDirection.UP) >= Boundlo1WeDo2Blocks.TILT_THRESHOLD ||
                this._getTiltAngle(WeDo2TiltDirection.DOWN) >= Boundlo1WeDo2Blocks.TILT_THRESHOLD ||
                this._getTiltAngle(WeDo2TiltDirection.LEFT) >= Boundlo1WeDo2Blocks.TILT_THRESHOLD ||
                this._getTiltAngle(WeDo2TiltDirection.RIGHT) >= Boundlo1WeDo2Blocks.TILT_THRESHOLD;
        default:
            return this._getTiltAngle(direction) >= Boundlo1WeDo2Blocks.TILT_THRESHOLD;
        }
    }
...
module.exports = Boundlo1WeDo2Blocks;

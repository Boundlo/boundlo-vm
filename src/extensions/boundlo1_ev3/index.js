...
/**
 * Enum for Ev3 device labels used in the Boundlo blocks/UI.
 * @readonly
 * @enum {string}
 */
const Ev3Label = {
...
class Boundlo1Ev3Blocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new EV3(this.runtime, Boundlo1Ev3Blocks.EXTENSION_ID);
    ...
    getInfo () {
        return {
            id: Boundlo1Ev3Blocks.EXTENSION_ID,
            name: 'LEGO EV3',
...
module.exports = Boundlo1Ev3Blocks;

...
/**
 * Manage communication with a GDX-FOR peripheral over a Boundlo Link client socket.
 */
class GdxFor {
...
/**
 * Boundlo! 1 blocks to interact with a GDX-FOR peripheral.
 */
class Boundlo1GdxForBlocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new GdxFor(this.runtime, Boundlo1GdxForBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: Boundlo1GdxForBlocks.EXTENSION_ID,
            name: Boundlo1GdxForBlocks.EXTENSION_NAME,
...
module.exports = Boundlo1GdxForBlocks;

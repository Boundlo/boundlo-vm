 ...
 * @type {string}
 */
const serverURL = 'https://translate-service.boundlo.mit.edu/';
...
/**
 * Class for the translate block in Boundlo! 1.
 * @constructor
 */
class Boundlo1TranslateBlocks {
    constructor () {
        /**
    ...
    getViewerLanguage () {
        ...
        // code instead of Boundlo's (e.g. for es-419 we look up es to get espanol)
    ...
    getLanguageCodeFromArg (arg) {
        ...
        // There are some languages we launched in the language menu that Boundlo did not
...
module.exports = Boundlo1TranslateBlocks;

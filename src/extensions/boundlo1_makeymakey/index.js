...
/**
 * Names used by keyboard io for keys used in boundlo.
 * @enum {string}
 */
...
/**
 * Class for the makey makey blocks in Boundlo! 1
 * @constructor
 */
class Boundlo1MakeyMakeyBlocks {
    constructor (runtime) {
        /**
    ...
    */
     ...
     * @param {string} key A boundlo key name.
     */
    keyPressed (key) {
        // Store only the first word of the Boundlo key name, so that e.g. when
...
module.exports = Boundlo1MakeyMakeyBlocks;

...
/**
 * Boundlo! 1 blocks to interact with a MicroBit peripheral.
 */
class Boundlo1MicroBitBlocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new MicroBit(this.runtime, Boundlo1MicroBitBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: Boundlo1MicroBitBlocks.EXTENSION_ID,
            name: Boundlo1MicroBitBlocks.EXTENSION_NAME,
    ...
    _isTilted (direction) {
        ...
        case MicroBitTiltDirection.ANY:
            return (Math.abs(this._peripheral.tiltX / 10) >= Boundlo1MicroBitBlocks.TILT_THRESHOLD) ||
                (Math.abs(this._peripheral.tiltY / 10) >= Boundlo1MicroBitBlocks.TILT_THRESHOLD);
        default:
            return this._getTiltAngle(direction) >= Boundlo1MicroBitBlocks.TILT_THRESHOLD;
        }
    }
...
module.exports = Boundlo1MicroBitBlocks;

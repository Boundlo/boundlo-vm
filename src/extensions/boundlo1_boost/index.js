...
class BoostMotor {
    ...
    constructor (parent, index) {
         ...
         * that will be called once Boundlo VM gets a notification from the Move Hub.
         * @type {Object}
         * @private
         */
...
/**
 * Boundlo! 1 blocks to interact with a LEGO Boost peripheral.
 */
class Boundlo1BoostBlocks {
    ...
    constructor (runtime) {
        ...
        this._peripheral = new Boost(this.runtime, Boundlo1BoostBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return {
            id: Boundlo1BoostBlocks.EXTENSION_ID,
            name: 'BOOST',
    ...
    _isTilted (direction) {
        ...
        case BoostTiltDirection.ANY:
            return (Math.abs(this._peripheral.tiltX) >= Boundlo1BoostBlocks.TILT_THRESHOLD) ||
                (Math.abs(this._peripheral.tiltY) >= Boundlo1BoostBlocks.TILT_THRESHOLD);
        default:
            return this._getTiltAngle(direction) >= Boundlo1BoostBlocks.TILT_THRESHOLD;
        }
    }
...
module.exports = Boundlo1BoostBlocks;

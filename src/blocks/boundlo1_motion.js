...
class Boundlo1MotionBlocks {
    ...
    getPrimitives () {
        return {
            ...
            motion_movestepsindirection: this.moveStepsInDirection,
    ...
    moveStepsInDirection (args, util) {
        const steps = Cast.toNumber(args.STEPS);
        const dir = Cast.toString(args.DIRECTION);
        var radians = null;
        switch(dir) {
            case 'opposite': 
                radians = MathUtil.degToRad(-90 - util.target.direction);
                break;
            case 'up': 
                radians = MathUtil.degToRad(180 - util.target.direction);
                break;
            case 'down': 
                radians = MathUtil.degToRad(180 + util.target.direction);
                break;
...
module.exports = Boundlo1MotionBlocks;

...
class Boundlo1DataBlocks {
    ...
    addToList (args, util) {
        const list = util.target.lookupOrCreateList(
            args.LIST.id, args.LIST.name);
        if (list.value.length < Boundlo1DataBlocks.LIST_ITEM_LIMIT) {
    ...
    insertAtList (args, util) {
        ...
        const listLimit = Boundlo1DataBlocks.LIST_ITEM_LIMIT;
...
module.exports = Boundlo1DataBlocks;
